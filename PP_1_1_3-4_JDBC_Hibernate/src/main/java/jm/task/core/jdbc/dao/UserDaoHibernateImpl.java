...
public class UserDaoHibernateImpl implements UserDao {
    ...
    public void createUsersTable() {
        ...
        try (Session session = Util.getSessionFactory().openSession()) {
            ...
            System.out.printf("%s - ошибка создания таблицы usersTable", e.getMessage());
            if (transaction != null) {
    ...
    public void dropUsersTable() {
        ...
        try (Session session = Util.getSessionFactory().openSession()) {
            ...
            System.out.printf("%s - ошибка удаления таблицы usersTable", e.getMessage());
            if (transaction != null) {
                transaction.rollback();
            }
        }
    ...
    public List<User> getAllUsers() {
        ...
        try (Session session = Util.getSessionFactory().openSession()) {
            ...
            System.out.printf("%s - ошибка получения всех пользователей из таблицы usersTable", e.getMessage());
            if (transaction != null) {
                transaction.rollback();
            }
        }
    ...
    public void cleanUsersTable() {
        ...
        try (Session session = Util.getSessionFactory().openSession()) {
            transaction = session.beginTransaction();
            session.createSQLQuery("TRUNCATE TABLE usersTable")
                    .executeUpdate();
            transaction.commit();
        } catch (HibernateException e) {
            System.out.printf("%s - ошибка удаления всех пользователей из таблицы usersTable", e.getMessage());
            if (transaction != null) {
                transaction.rollback();
            }
        }
